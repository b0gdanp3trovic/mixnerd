      ...
      <Navbar className={"navbar"} expand="lg">
        ...
        <div className={"pageContainer"}>
            ...
            <div className={"formContainer"}>
                ...
                <Button disabled={dataLoading} className={"button"} onClick={handleClick} variant="light">Listen!</Button>{' '}
                <label className={"timestamplabel"}>Timestamps:</label>
                <Form.Group controlId="formBasicCheckbox">
                    <Form.Check disabled={dataLoading} type="checkbox" onChange={() => setWithTimestamps(!withTimestamps)}/>
                </Form.Group>
            </div>
            <p className={"tsWarning"}>Plase note that with timestamps, the processing of the file will take a significantly larger amount of time.</p>
